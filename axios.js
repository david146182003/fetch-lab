...
const API_KEY = "live_wB3RLes00jJEacFc6JurdwoUbnwQwb6XrQnUGELWMTp9lh1mK6PpTvEAD5mViUwe";
 ...
 *  - Append each of these new elements to the carousel.n 
...
const initialLoad = ()=>{
   ...
   .then(response => response.forEach(breed =>{
    const option =document.createElement('option');
    option.textContent= breed.name;
    option.value = breed.id;
    breedSelect.appendChild(option)
